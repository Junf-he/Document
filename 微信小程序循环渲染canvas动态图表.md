...
![](C:\GitHub\难点和易错点\difficulties-and-mistakes\images\微信小程序canvas成品.png)
...
- js部分
  ...
  ![](C:\GitHub\难点和易错点\difficulties-and-mistakes\images\第一版样式.png)
  ...
  ![](C:\GitHub\难点和易错点\difficulties-and-mistakes\images\js错误案例.png)

  控制台打印index值：

  ![](C:\GitHub\难点和易错点\difficulties-and-mistakes\images\js错误控制台打印.png)
